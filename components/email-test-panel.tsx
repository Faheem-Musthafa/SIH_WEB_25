...
export default function EmailTestPanel() {
  ...
  const handleTestEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const testEmail = (form.elements.namedItem("testEmail") as HTMLInputElement)
      .value;
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> This will send a registration confirmation
          email to the specified address to test your SMTP configuration.
        </p>
      </div>
    </div>
  );
